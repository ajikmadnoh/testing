...
<head>
    ...
    <title>Sunstone Trading Management System</title>
    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            ...
            @else
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"> Resources <span class="caret"></span>
                        </a>
